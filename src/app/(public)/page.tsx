...
export default function LandingPage() {
  const jsonLd = {
    ...
    description: "Application web d'apprentissage de l'arabe pour les enfants musulmans.",
    aggregateRating: {
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Puis-je résilier à tout moment ?", a: "Oui, cest sans engagement. L'abonnement s'arrêtera à la fin du mois en cours après résiliation." }
            ].map((faq, i) => (
